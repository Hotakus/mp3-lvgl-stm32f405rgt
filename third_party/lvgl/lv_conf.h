...
#  define LV_MEM_ATTR __align(4)

/* Set an address for the memory pool instead of allocating it as an array.
 * Can be in external SRAM too. */
#  define LV_MEM_ADR         0//(0x20020000-LV_MEM_SIZE)
 ...
 */
#define LV_FONT_CUSTOM_DECLARE  LV_FONT_DECLARE( consolas_8 ) \
                                LV_FONT_DECLARE( consolas_12 ) \
                                LV_FONT_DECLARE( yahei_consolas_12 ) \
                                LV_FONT_DECLARE( yahei_consolas_16 )
...
#define LV_USE_LED      1
#if LV_USE_LED
#  define LV_LED_BRIGHT_MIN  0      /*Minimal brightness*/
...
#if LV_USE_SPINNER != 0
#  define LV_SPINNER_DEF_ARC_LENGTH   30      /*[deg]*/
